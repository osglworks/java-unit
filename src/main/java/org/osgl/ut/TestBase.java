...
public abstract class TestBase extends Assert {
     ...
     * @param message the message, `null` okay
     * @param messageArgs the message arguments
     * @return empty string `""` if `messsage` is `null` or result of {@link String#format(String, Object...)}
     */
    ...
    private static String eqMsg(String message, Object expected, Object actual) {
        String formatted= "";
